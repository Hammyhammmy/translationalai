# Free / open-source GU anatomy images

All from Wikimedia Commons. Licenses below — keep attribution for CC-BY/CC-BY-SA when used.

| file | what | license | author | source |
|---|---|---|---|---|
| `innervation__gray1138.png` | Bladder/pelvic vessels & nerves (Gray's) | Public domain | Henry Vandyke Carter | [Commons](https://commons.wikimedia.org/wiki/File%3AGray1138.png) |
| `innervation__gray1140.png` | Bladder interior/nerves (Gray's) | Public domain | Henry Vandyke Carter | [Commons](https://commons.wikimedia.org/wiki/File%3AGray1140.png) |
| `kidney__2610_the_kidney.jpg` | Kidney — gross + section (OpenStax) | CC BY 3.0 | OpenStax College | [Commons](https://commons.wikimedia.org/wiki/File%3A2610_The_Kidney.jpg) |
| `kidney__blausen_0592_kidneyanatomy_01.png` | Kidney anatomy cross-section (Blausen) | CC BY 3.0 | BruceBlaus. When using this image in external sources it can be cited as:

Blausen.com sta | [Commons](https://commons.wikimedia.org/wiki/File%3ABlausen_0592_KidneyAnatomy_01.png) |
| `kidney__kidneystructures_piom.svg` | Kidney structures — vector | CC BY-SA 3.0 | Piotr Michał Jaworski; PioM EN DE PL | [Commons](https://commons.wikimedia.org/wiki/File%3AKidneyStructures_PioM.svg) |
| `malepelvis__gray1136.png` | Male bladder/urethra (Gray's) | Public domain | Henry Vandyke Carter | [Commons](https://commons.wikimedia.org/wiki/File%3AGray1136.png) |
| `malepelvis__gray1153.png` | Male pelvis sagittal (Gray's) | Public domain | Henry Vandyke Carter | [Commons](https://commons.wikimedia.org/wiki/File%3AGray1153.png) |
| `nephron__2618_nephron_secretion_reabsorption.jpg` | Nephron secretion/reabsorption (OpenStax) | CC BY 3.0 | OpenStax College | [Commons](https://commons.wikimedia.org/wiki/File%3A2618_Nephron_Secretion_Reabsorption.jpg) |
| `nephron__nephron_anatomy.png` | Nephron anatomy — labeled | CC BY-SA 4.0 | BruceBlaus | [Commons](https://commons.wikimedia.org/wiki/File%3ANephron_Anatomy.png) |
| `nephron__physiology_of_nephron.png` | Nephron physiology (Holly Fischer) | CC BY 3.0 | Madhero88 | [Commons](https://commons.wikimedia.org/wiki/File%3APhysiology_of_Nephron.png) |
| `overview__female_and_male_urethra.jpg` | Female vs male urethra (OpenStax) | CC BY 3.0 | OpenStax College | [Commons](https://commons.wikimedia.org/wiki/File%3AFemale_and_Male_Urethra.jpg) |
| `overview__illu_urinary_system.jpg` | Urinary system — labeled overview (SEER) | Public domain | Arcadian | [Commons](https://commons.wikimedia.org/wiki/File%3AIllu_urinary_system.jpg) |
| `overview__urinary_system_female.png` | Urinary system (female) | CC BY-SA 4.0 | BruceBlaus | [Commons](https://commons.wikimedia.org/wiki/File%3AUrinary_System_%28Female%29.png) |
| `overview__urinary_system.svg` | Urinary system — vector overview | CC BY-SA 3.0 | Jordi March i Nogué [1] | [Commons](https://commons.wikimedia.org/wiki/File%3AUrinary_system.svg) |
| `pathology__blausen_0595_kidneystones.png` | Kidney stones (Blausen) | CC BY 3.0 | BruceBlaus. When using this image in external sources it can be cited as:

Blausen.com sta | [Commons](https://commons.wikimedia.org/wiki/File%3ABlausen_0595_KidneyStones.png) |
| `pathology__hydronephrosis_hydroureter.png` | Hydronephrosis + hydroureter (back-pressure) | Public domain | National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK), National Institu | [Commons](https://commons.wikimedia.org/wiki/File%3AHydronephrosis_Hydroureter.png) |
